...
def update_loan_financial_form(_id, late_interest, belated_int, penal_int, p_due, p_ndue, i_due):
    ...
    if email is not None:
        if request.method == 'GET':
            ...
            print(cl_bal_p_due, cl_bal_i_due)
...
def mini_demand_form(_id, belated_int, penal_int, p_due, p_ndue, i_due, old_interest, demand_date):
    ...
    if email is not None:
        if request.method == 'GET':
            ...
            d_number, main_demand_date, ann_id = None, None, None
            main_demand_principal_due, main_demand_interest_due = 0, 0
            ...
            for demand in demands[0:1]:
                ...
                main_demand_principal_due = int(demand['closing_balance_principal_due'])
                main_demand_interest_due = int(demand['closing_balance_interest_due'])
                ...
                d_number = int(demand['demand_number'])
            ...
            if d_number == 1:
                ...
                opening_balance_principal_due = main_demand_principal_due
                opening_balance_interest_due = main_demand_interest_due
